...
class FakeTest < Test::Unit::TestCase
  ...
  def test_install_fake_on_class
    a1 = A.new()
    RDouble::Fake.install_fake(A, "a", method(:b))
    a2 = A.new()
  ...
  def test_install_on_one_instance
    a1 = A.new()
    a2 = A.new() 
    RDouble::Fake.install_fake(a1, "a", method(:b))
    a3 = A.new()
    assert_equal("method returns b", a1.a())
    assert_equal("instance method returns a", a2.a())
  ...
  def test_install_on_bool
    ...
    RDouble::Fake.install_fake(true, "inspect", method(:fake_inspect))
  ...
  def test_abs_on_1
    ...
    RDouble::Fake.install_fake(1, "abs", method(:fake_abs))
